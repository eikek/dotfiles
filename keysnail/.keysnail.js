...
// key.setGlobalKey(["C-x", "C-f"], function(ev) {
//     var size = getBrowser().mTabContainer.itemCount;
//     var tab = getBrowser().mTabContainer.appendItem("New tab", getBrowser().mTabContainer.value);
//     getBrowser().mTabContainer.selectedItem = tab;
//     command.focusToById("urlbar");   
// }, 'New tab', true);

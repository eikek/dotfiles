...
# set -gx AWS_ACCESS_KEY_ID (pass tundra/aws/security/eike.kettner/aws-access-key)
# set -gx AWS_SECRET_ACCESS_KEY (pass tundra/aws/security/eike.kettner/aws-secret-key)
